...
public class TimeEntryApiTest {
    ...
    public void testCreate() throws Exception {
        ...
        Proxy proxy = new Proxy(Proxy.Type.HTTP, new InetSocketAddress("localhost", 80));
        clientHttpReq.setProxy(proxy);
        RestTemplate template = new RestTemplate(clientHttpReq);
       // ResponseEntity<String> createResponse = template.postForEntity("/time-entries", timeEntry, String.class);*/
